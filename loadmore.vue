...
<script type="text/babel">
  ...
  <mt-loadmore :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore" :auto-fill="autoFill">
    <c-goods v-for="(goods, index) in quickData" :goodsDetail="goods" :index="index" :isSelect="isSelect" :quickOrder="quickOrder" @selectFromTeam="selectGoods" :jumpType="jumpType" :length="quickData.length"></c-goods>
  </mt-loadmore>
